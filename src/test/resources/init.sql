...
INSERT INTO seasons (season_id, season_name, start_date)
VALUES (1, '2023-24', '2023-10-24');

INSERT INTO teams (team_id, team_name, team_abbreviation, team_conference)
VALUES (1, 'Los Angeles Lakers', 'LAL', 'WEST');

INSERT INTO teams (team_id, team_name, team_abbreviation, team_conference)
VALUES (2, 'Boston Celtics', 'BOS', 'EAST');

INSERT INTO players (player_id, player_first_name, player_last_name, player_position)
VALUES (1, 'LeBron', 'James', 'SF');

INSERT INTO players (player_id, player_first_name, player_last_name, player_position)
VALUES (2, 'Jayson', 'Tatum', 'SF');

INSERT INTO player_teams (player_id, team_id, season_id, join_date)
VALUES (1, 1, 1, '2023-10-24');

INSERT INTO player_teams (player_id, team_id, season_id, join_date)
VALUES (2, 2, 1, '2023-10-24');

INSERT INTO games (game_id, game_date, home_team_id, away_team_id, season_id)
VALUES (1, '2023-11-01', 1, 2, 1);